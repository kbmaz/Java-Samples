...
public class Dukes {
  ...
  private String action = "../../images/duke/dukeWave.gif"; // default Dukes are
// friendly
  ...
  // Or when the applet instantiates the Duke, let it say if he is angry--a new
// Constructor.

  public Dukes(Color nose, boolean isMad) {
    // give Duke instance specified values for traits that are passed from the
// class that instantiated
  ...
  public void setMood() {
    // toggle the boolean value. If it was true it becomes false; if false it
// becomes true
    angry = !angry;
    if (angry == true)
      angryMessage = "I QUIT!!";
